...
def get_semantic_mag(intrinsic_matrix,extrinsic_matrix,bag_time,time,camera_id):
    point_cloud = o3d.io.read_point_cloud(f"../dataset/raw/{bag_time}/cloudpoints/{time}.pcd")
...
if __name__ == "__main__":
    for file_name in os.listdir("/home/guide/GuideDog/dataset/rosbag_raw"):
        if os.path.isfile(os.path.join("/home/guide/GuideDog/dataset/rosbag_raw", file_name)):
            ...
            folder_path = '../dataset/raw/'+bag_time+'/cloudpoints/'
            ...
            for filename in os.listdir(folder_path):
                if filename.endswith('.pcd'):
                    ...
                    output = f"../dataset/preprocess/{bag_time}/BEV/{timestamp}.jpg"
                    if not os.path.exists(f"../dataset/preprocess/{bag_time}/BEV"):
                        os.makedirs(f"../dataset/preprocess/{bag_time}/BEV")
